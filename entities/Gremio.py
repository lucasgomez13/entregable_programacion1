...
class Gremio:
    ...
    def realizar_mision(self):
            ...
            try:
                ...
                if aventurero_encontrado:
                    ...
                    if self.validar_rango(aventurero_encontrado, mision_encontrada):
                        mision_aventureros.append(aventurero_encontrado)
        ...
        if len(mision_aventureros) >= mision_encontrada.cantidad_minima_miembros:
            mision_encontrada.completado = True
            recompensa_por_aventurero = mision_encontrada.recompensa / len(mision_aventureros)

            for aventurero in mision_aventureros:
